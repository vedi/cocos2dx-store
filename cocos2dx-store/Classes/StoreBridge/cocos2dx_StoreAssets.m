...
@implementation cocos2dx_StoreAssets

static NSString* TAG = @"SOOMLA cocos2dx_StoreAssets";

- (id)initWithStoreAssetsDict:(NSString*)storeAssetsDict andVersion:(int)oVersion{
    self = [super init];
    if(self){
        version = oVersion;
