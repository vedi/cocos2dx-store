#include "com_soomla_store_EventHandlerBridge.h"
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_marketPurchase
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_marketRefund
  (JNIEnv * env, jobject obj, jstring productId){
	  string productIdStr = cocos2d::JniHelper::jstring2string(productId);
	  string msg(productIdStr);
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_virtualGoodPurchased
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_virtualGoodEquipped
  (JNIEnv * env, jobject obj, jstring itemId){
	  string itemIdStr = cocos2d::JniHelper::jstring2string(itemId);
	  string msg(itemIdStr);
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_virtualGoodUnequipped
  (JNIEnv * env, jobject obj, jstring itemId){
	  string itemIdStr = cocos2d::JniHelper::jstring2string(itemId);
	  string msg(itemIdStr);
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_billingSupported
  (JNIEnv * env, jobject obj){
	  __android_log_write(ANDROID_LOG_DEBUG, "SOOMLA JNI", "Billing is supported.");
  }

JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_billingNotSupported
  (JNIEnv * env, jobject obj){
	  __android_log_write(ANDROID_LOG_DEBUG, "SOOMLA JNI", "Billing is not supported.");
  }

JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_marketPurchaseProcessStarted
  (JNIEnv * env, jobject obj, jstring productId){
	  string productIdStr = cocos2d::JniHelper::jstring2string(productId);
...
JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_goodsPurchaseProcessStarted
  (JNIEnv * env, jobject obj){
	  __android_log_write(ANDROID_LOG_DEBUG, "SOOMLA JNI", "VirtualGoods purchase started.");
  }

JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_closingStore
  (JNIEnv * env, jobject obj){
	  __android_log_write(ANDROID_LOG_DEBUG, "SOOMLA JNI", "Store is closing.");
  }

JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_unexpectedErrorInStore
  (JNIEnv * env, jobject obj){
	  __android_log_write(ANDROID_LOG_DEBUG, "SOOMLA JNI", "Unexpected error occured.");
  }

JNIEXPORT void JNICALL Java_com_soomla_store_EventHandlerBridge_openingStore
  (JNIEnv * env, jobject obj){
