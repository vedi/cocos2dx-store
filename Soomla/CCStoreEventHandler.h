...
namespace soomla {
    ...
    public:
         ...
         */
        virtual void onItemPurchased(CCPurchasableVirtualItem *purchasableVirtualItem, cocos2d::__String *payload) = 0;
        ...
        */
         ...
         */
        virtual void onUnexpectedErrorInStore(cocos2d::__String *errorMessage) = 0;
        ...
        */
         ...
         */
        virtual void onMarketItemsRefreshFailed(cocos2d::__String *errorMessage) = 0;
